...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { description: @assignment.description, status: @assignment.status } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { description: @assignment.description, status: @assignment.status } }
